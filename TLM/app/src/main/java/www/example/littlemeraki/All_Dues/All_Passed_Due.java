...
public class All_Passed_Due extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_passed__due__date, container, false);
        ...
        String btn_visible="passed";
        no_data=view.findViewById(R.id.no_data_pass_due);
        recview = view.findViewById(R.id.all_passed_due_recview);
